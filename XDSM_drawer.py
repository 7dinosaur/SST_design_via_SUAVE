...
x.connect("SUAVE", "aerodynamic", r"x_i")
...
x.add_input("SUAVE", r"x_0,x_1\dots x_N")

x.add_output("route_opt", r"\Gamma*", side=LEFT)
x.add_output("aircraft_opt", "MTOW*", side=LEFT)

# x.add_output("opt", "x^*, z^*", side=LEFT)
# x.add_output("Range", "y_1^*", side=LEFT)
# x.add_output("land", "y_2^*", side=LEFT)
